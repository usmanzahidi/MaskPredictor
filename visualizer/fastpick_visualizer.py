...
class FastPickVisualizer(Visualizer):

    def __init__(self, img_rgb, metadata=None, scale=1.0, instance_mode=ColorMode.SEGMENTATION):
        super(FastPickVisualizer,self).__init__(img_rgb, metadata, scale, instance_mode)
    ...
    def overlay_instances(
        ...
        *,
        ...
        """
        uz: overrided function to customize masks as per Fastpick requirements
